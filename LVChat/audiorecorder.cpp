...
QString SimpleAudioRecorder::file()
{
    return m_filePath;
}
...
bool SimpleAudioRecorder::setupRecorder()
{
    ...
    //audio codecs;
    QStringList codecs = m_recorder.supportedAudioCodecs();  //返回音频编码解码器列表
    ...
    //containers
    QStringList containers = m_recorder.supportedContainers();  //返回支持格式的列表
